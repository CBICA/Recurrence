...
void DownloadManager::startNextDownload()
{
	...
	if (!output.open(QIODevice::WriteOnly)) 
	{
		...
		MITK_INFO << errormsg.toStdString();
	...
	MITK_INFO << " Starting Download: " << std::string(url.toEncoded().constData());
	downloadTimer.start();
}
...
void DownloadManager::reportRedirect()
{
	...
	MITK_INFO << requestmsg.toStdString();
	...
	MITK_INFO << redirectmsg.toStdString();
